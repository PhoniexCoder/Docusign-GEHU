  ...
  return (
    <div className="relative">
      ...
      <div className="p-2 w-full bg-base-100 text-base-content op-card shadow-lg">
        ...
        <div
          className={`overflow-auto w-full rounded-xl border border-base-200 ${props.List?.length > 0
              ? isDashboard
                ? "min-h-[317px] max-h-[500px]"
        ...
        >
          <table className="table table-pin-rows w-full mb-0 bg-base-100">
            <thead className="text-xs uppercase font-bold text-base-content/60 bg-base-200/50">
              <tr className="border-b border-base-200">
                {props.heading?.map((item, i) => (
                  <th key={i} className="py-4 px-4 font-bold tracking-wider text-center">
            ...
            <tbody className="text-sm font-medium">
              {props.List?.length > 0 &&
                ...
                currentList.map((item, index) => (
                  <tr
                    className="border-b border-base-100 hover:bg-base-200/30 transition-colors last:border-none group"
                    key={index}
                  >
