  ...
  return (
    <div className="flex py-[5px]">
      {isMobile && props?.isShowHeader ? (
                  ...
                  <div className="flex items-center" data-tut="reactourFifth">
                    ...
                    {props?.isPlaceholder ? (
                      <div
                        ...
                        className={`${props?.isMailSend ? "" : "op-link-primary"
                    ...
                    <DropdownMenu.Root>
                      ...
                      <DropdownMenu.Portal>
                        <DropdownMenu.Content
                          className="bg-base-100 shadow-md rounded-md px-3 py-2"
                          sideOffset={5}
                        >
        ...
        <div className="flex flex-wrap justify-between items-center w-full gap-2 px-2 py-1">
          <PrevNext
            pageNumber={props?.pageNumber}
            allPages={props?.allPages}
            changePage={props?.changePage}
            ...
            <div className="flex flex-row gap-2">
              {props?.isCompleted && (
                <button
                  type="button"
                  onClick={() =>
                    handleDownloadCertificate(props?.pdfDetails, setIsDownloading)
                  }
                  className="op-btn op-btn-secondary op-btn-sm gap-2 font-medium text-[12px] shadow"
                >
              ...
              <button
                ...
                type="button"
                className="op-btn op-btn-neutral op-btn-sm gap-2 font-medium text-[12px] shadow"
              >
              ...
              <button
                type="button"
                className="op-btn op-btn-primary op-btn-sm gap-2 font-medium text-[12px] shadow"
              ...
              <button
                type="button"
                className="op-btn op-btn-info op-btn-sm gap-2 font-medium text-[12px] shadow"
                onClick={() => props?.setIsEmail(true)}
              >
                <i className="fa-light fa-envelope" aria-hidden="true"></i>
                <span className="hidden lg:block">{t("mail")}</span>
              </button>
              <button
                type="button"
                className="op-btn op-btn-ghost text-base-content op-btn-sm gap-2 font-medium text-[12px]"
                onClick={() => navigate("/drive")}
              >
                <i className="fa-light fa-check-circle" aria-hidden="true"></i>
                <span className="hidden lg:block">{t("done")}</span>
              </button>
            </div>
          ) : props?.isPublicTemplate ? (
            <div className="flex">
