...
export const cloudServerUrl = 'http://127.0.0.1:8080/app';
export const serverAppId = process.env.APP_ID || 'docusign';
export const appName = 'DocuSign';
...
export const updateMailCount = async (extUserId, plan, monthchange) => {
  ...
  try {
    ...
    if (contractUser) {
      ...
      if (plan === 'freeplan') {
        /*
        // Bypass limit enforcement by not incrementing MonthlyFreeEmails
       if (monthchange) {
...
export const mailTemplate = param => {
  ...
  const opurl = ` <a href='mailto:complaint@docusign.com' target=_blank>here</a>`;
