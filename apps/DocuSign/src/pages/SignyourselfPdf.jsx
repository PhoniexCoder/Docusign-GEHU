      ...
      {isLoading.isLoad ? (
        ...
        <div>
          ...
          <div className="relative op-card overflow-hidden flex flex-col md:flex-row justify-between bg-base-300">
            ...
            />
            {/* Main Content Area: PDF + Toolbar + Right Widgets */}
            <div className="flex-1 flex flex-col md:flex-row h-full relative z-10 overflow-hidden">
              {/* Center PDF Area */}
              <div className="flex-1 flex relative flex-col h-full overflow-hidden">
                {/* Top Header */}
                <div className="w-full bg-base-100 border-b border-base-200 z-20 shrink-0">
                  <Header
                    pageNumber={pageNumber}
                    allPages={allPages}
                ...
                <div className="flex-1 relative overflow-auto bg-base-200/30 touch-auto" ref={divRef} data-tut="reactourSecond">
                  ...
                  <div className="flex justify-center min-h-max pb-20 px-4 md:px-8 relative">
                    <div className="relative shadow-xl transition-all duration-300 ease-in-out">
                      {!pdfBase64Url || isUiLoading ? (
              ...
              <div className="w-full md:w-[280px] lg:w-[320px] bg-base-100 border-l border-base-200 z-20 flex flex-col shadow-[-4px_0_15px_-3px_rgba(0,0,0,0.1)]">
                <div className="h-full overflow-y-auto hide-scrollbar">
                  {!isCompleted ? (
                    <>
                      <div className="p-4 border-b border-base-200 bg-base-100 sticky top-0 z-10">
                        <h3 className="font-bold text-lg text-base-content flex items-center gap-2">
                          <i className="fa-light fa-toolbox text-primary"></i>
                          {t("signature-tools")}
                        </h3>
                        <p className="text-xs text-base-content/60 mt-1">{t("drag-drop-widgets")}</p>
                      </div>
                      <div className="p-2">
                        <WidgetComponent
                          pdfUrl={pdfUrl}
            ...
            >
              <div className="p-[20px] h-full text-base-content">
                ...
                <div className="h-[1px] w-full my-[15px] bg-base-200"></div>
                <button
                  className="op-btn op-btn-ghost text-base-content shadow-sm border border-base-200"
