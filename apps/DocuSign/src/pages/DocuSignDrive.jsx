...
import "../styles/docusigndrive.css";
import {
  getThemeIconColor,
} from "../constant/const";
import {
...
const DriveBody = lazyWithRetry(
  () => import("../components/docusigndrive/DriveBody")
);
const dropdowncss =
...
function DocuSignDrive() {
  ...
  const tourConfigs = [
    {
      ...
      content: () => (
        <TourContentWithBtn
          message={t("tour-mssg.DocuSign-drive-1")}
    ...
    },
    {
      ...
      content: () => (
        <TourContentWithBtn
          message={t("tour-mssg.DocuSign-drive-2")}
          isChecked={handleDontShow}
        />
      ),
      position: "top",
    ...
    },
    {
      ...
      content: () => (
        <TourContentWithBtn
          message={t("tour-mssg.DocuSign-drive-3")}
          isChecked={handleDontShow}
        />
      ),
      position: "top",
    ...
    },
    {
      ...
      content: () => (
        <TourContentWithBtn
          message={t("tour-mssg.DocuSign-drive-4")}
          isChecked={handleDontShow}
        />
      ),
      position: "top",
  ...
  const getPdfDocumentList = async (disbaleLoading) => {
    ...
    try {
        ...
        const addMoreTour = [
          {
            ...
            content: () => (
              <TourContentWithBtn
                message={t("tour-mssg.DocuSign-drive-5")}
                isChecked={handleDontShow}
              />
            ),
            position: "bottom",
          ...
          },
          {
            ...
            content: () => (
              <TourContentWithBtn
                message={t("tour-mssg.DocuSign-drive-6")}
                isChecked={handleDontShow}
              />
            ),
            position: "bottom",
          ...
          },
          {
            ...
            content: () => (
              <TourContentWithBtn
                message={t("tour-mssg.DocuSign-drive-7")}
                isChecked={handleDontShow}
              />
            ),
            position: "bottom",
      ...
      if (!docId) {
        setFolderName([
          { name: t("DocuSign-drive", { appName: drivename }), objectId: "" }
        ]);
      }
    } catch (e) {
      setIsAlert({
