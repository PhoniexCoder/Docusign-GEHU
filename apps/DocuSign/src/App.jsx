...
const DocuSignDrive = lazyWithRetry(() => import("./pages/DocuSignDrive"));
...
function App() {
  ...
  useEffect(() => {
    // initialize creds
    const id = process.env.REACT_APP_APPID ?? "docusign";
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route element={<HomeLayout />}>
              ...
              <Route path="/drive" element={<Lazy Page={DocuSignDrive} />} />
