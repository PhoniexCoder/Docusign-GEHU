  ...
  return (
    ...
    >
      <div className="flex items-center justify-start gap-5">
        <div className={`rounded-2xl w-[64px] h-[64px] flex justify-center items-center shrink-0 shadow-lg shadow-base-200 docusigndark:shadow-primary/10 ${props.BgColor?.includes("bg-primary") ? "bg-primary/10 text-primary docusigndark:bg-gradient-primary docusigndark:text-white" :
          props.BgColor?.includes("bg-info") ? "bg-info/10 text-info docusigndark:bg-gradient-info docusigndark:text-white" :
            props.BgColor?.includes("bg-success") ? "bg-success/10 text-success docusigndark:bg-gradient-success docusigndark:text-white" :
              props.BgColor?.includes("bg-warning") ? "bg-warning/10 text-warning docusigndark:bg-gradient-warning docusigndark:text-white" : "bg-primary/10 text-primary docusigndark:bg-gradient-primary docusigndark:text-white"
          }`}>
          <i
