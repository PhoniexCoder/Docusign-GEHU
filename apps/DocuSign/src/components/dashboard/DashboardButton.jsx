  ...
  return (
    <button
      ...
      className={`${props.Data && props.Data.Redirect_type
        ? "cursor-pointer"
        : "cursor-default"
        } flex items-center gap-2 px-4 py-2.5 rounded-xl text-base-content/70 hover:text-black hover:bg-base-200 docusigndark:hover:text-white docusigndark:hover:bg-gradient-primary hover:shadow-md docusigndark:hover:shadow-primary/20 transition-all duration-300 group`}
    >
      <i
