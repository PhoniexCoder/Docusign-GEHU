...
export const RenderReportCell = ({
  ...
  switch (col) {
    ...
    case "Title":
      return (
        <td key={col} className="p-4 min-w-56 max-w-xs">
          <div className="font-bold text-sm text-base-content break-words">{rowData?.Name}</div>
    ...
    case "Folder":
      return (
        <td key={col} className="p-2 text-center">
          {rowData?.Folder?.Name ||
            t("sidebar.DocuSign™ Drive", { appName: drivename })}
        </td>
      );
    case "File":
      return (
